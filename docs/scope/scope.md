...
- [ ] Build it: /develop v3 auto fix and history
  ...
  - [ ] Patch generation, test runner, and suggestion posting: eligibility filter, structured generation, validation, workspace clone, targeted tests, suggestion as the finding's comment (AC-1, AC-2, AC-3)
